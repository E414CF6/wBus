...
type BusStopMarkerItemProps = {
    stop: BusStop; onRouteChange?: (routeName: string) => void;
};
...
const BusStopMarkerItem = memo(({stop, onRouteChange}: BusStopMarkerItemProps) => {
    ...
    return (<>
        ...
        >
            <div
                className="flex flex-col bg-white/95 dark:bg-[#111111]/95 backdrop-blur-3xl overflow-hidden rounded-[28px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.5)] border border-black/4 dark:border-white/6 w-75 sm:w-90">
                {/* Header Section */}
                <div
...
export default ({
    ...
    routeName: string; onRouteChange?: (routeName: string) => void;
}) => {
