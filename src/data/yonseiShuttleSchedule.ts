...
export const YONSEI_SHUTTLE_SCHEDULE: ShuttleBusScheduleData = {
    ...
    guidelines: ["버스는 정시 출발합니다. 출발 5분 전까지 탑승 완료 바랍니다.", "차량 고장 또는 기타 부득이한 사정으로 운행이 불가능할 수 있으며, 도로 사정 등으로 버스탑승 시각이 지연될 수 있습니다.", "미래캠퍼스발 셔틀버스 탑승 후 매지리에서 하차를 원하실 경우 버스 기사님께 미리 말씀해 주세요.", "효율적 운영을 위해 시간이 변동될 수 있으니 공지사항을 수시로 확인해주시기 바랍니다.",],
};
