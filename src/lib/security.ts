...
const IP_SALT = process.env.IP_SALT || process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY?.slice(0, 24) || "wbus_secure_community_salt_2026";
...
const PROFANITY_PATTERNS: RegExp[] = [/(시발|씨발|씨바|시바|병신|븅신|개새끼|개색히|새끼|존나|좆|지랄|느금|애미|애비|느개비|호로|창녀|보지|자지|틀딱|한남충|한녀충|맘충)/i,];
